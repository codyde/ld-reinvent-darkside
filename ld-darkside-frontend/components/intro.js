...
export default function Intro() {
  ...
  return (
        ...
        <p className="text-xl">
          ...
          with the <span className="text-aws">Lambda</span>, <span className="text-blue-400 font-bold">Dark Launching</span> is the
        ...
        <h1 className="text-xl text-aws">
          ...
          <span className="text-blue-400 font-bold"> Login Box</span> flag to begin your journey to the <span className="text-red-400">Dark Side</span>
        </h1>
      </div>
  );
}
